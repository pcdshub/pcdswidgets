...
class MotorStateMover(MotorStateMoverBase):
    ...
    def __init__(self, parent: QWidget | None = None):
        ...
        # The moving/done label (movingIndicatorLabel) is a MovingLabel promoted
        # in the .ui and connected to STATE:BUSY_RBV like the moving LED, so it
        # updates through the normal PyDM channel machinery -- no runtime setup.
