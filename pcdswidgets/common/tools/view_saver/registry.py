...
def _make_getter(widget: QWidget, path: str, save_fn: Callable) -> Callable:
...
def _make_setter(widget: QWidget, path: str, load_fn: Callable) -> Callable:
...
WIDGET_REGISTRY: dict[str, dict[str, tuple[str, str, Callable, Callable]]] = {
    ...
    "QGroupBox": {"checked": ("isChecked", "setChecked", json.loads, json.dumps)},
    "QCheckBox": {"checked": ("isChecked", "setChecked", json.loads, json.dumps)},
    "QPushButton": {"checked": ("isChecked", "setChecked", json.loads, json.dumps)},
